...
export const FILE_CATEGORIES = {
  ...
  // ── Zone: GENERATED authority documents ──────────────────────────────────
  // Separate from APPLICATION_FORM because certification forms are generated
  // independently and must never be confused with received permit documents.
...
/**
 * Generated package and authority document outputs.
 * Used by n8n after package generation completes.
 * Files in this zone should be treated as authoritative final outputs.
 *
 * Includes both the permit package and any authority-specific documents
 * (application form, certification form) generated by the overlay pipeline.
 */
export const GENERATED_FILE_CATEGORIES: FileCategoryValue[] = [
  FILE_CATEGORIES.PERMIT_PACKAGE,
  FILE_CATEGORIES.APPLICATION_FORM,
  FILE_CATEGORIES.CERTIFICATION_FORM,
];

// ── Page template storage bucket ─────────────────────────────────────────────

export const PAGE_TEMPLATES_BUCKET = "page-templates";
